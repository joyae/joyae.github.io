...
## :evergreen_tree: Spotify의 기존 추천시스템 - Collaborative Filtering
...
## :evergreen_tree: 다른 접근 방법 - Content-Based Recommendation
...
## :evergreen_tree: Audio Signal과 Deep Learning을 활용한 음악 취향 예측
...
## :evergreen_tree: About The Deep Learning Model
...
## :evergreen_tree: 모델 분석 - Deep Learning Model은 무엇을 학습하는가?
